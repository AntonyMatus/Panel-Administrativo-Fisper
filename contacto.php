            ...
            <div class="container">
                <div class="row align-items-stretch justify-content-center extra-small-screen">
                    <div class="col-12 position-relative page-title-large text-left d-flex  justify-content-center flex-column">
                        <h1 class="alt-font text-dark-gray font-weight-500 no-margin-bottom">PONGÁMOSNOS EN CONTACTO</h1><br>
        ...
        <!-- end page title -->
         ...
         <section class="p-0 wow animate__fadeIn">
            <div class="container-fluid">
                <div class="row justify-content-center display-initial">
                    <div class="col-12 col-xl-12 col-lg-7 text-center margin-4-half-rem-bottom md-margin-3-rem-bottom">
                        <h4 class="alt-font font-weight-600 text-green2">NUESTRA OFICINA</h4>
                    </div>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-10">
                        <div class="row justify-content-center">
                            <div class="col-12 col-xl-10 col-lg-7 text-center margin-4-half-rem-bottom md-margin-3-rem-bottom">
                                <h4 class="alt-font font-weight-600 text-green2">COMUNÍCATE CON NOSOTROS</h4>
                            </div>
                            <div class="col-12">
                                <!-- start contact form -->
                                <form action="email-templates/contact-form.php" method="post">
                                    <div class="row row-cols-1 row-cols-md-2">
                                        ...
                                        <div class="col text-center text-md-end">
                                            ...
                                            <button class="btn btn-medium btn-brown2 mb-0 submit" type="submit">Enviar</button>
                                        </div>
                                    </div>
