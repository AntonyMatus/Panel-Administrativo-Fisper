            ...
            <div class="container">
                <div class="row align-items-stretch justify-content-center small-screen">
                    <div class="col-12 position-relative page-title-extra-small text-center d-flex  justify-content-center flex-column">
                        <h1 class="text-left alt-font text-dark-gray opacity-6 margin-20px-bottom">conoce nuestra historia</h1>
                        <h2 class="text-left text-green2 alt-font font-weight-500 w-55 md-w-65 sm-w-80 center-col xs-w-100 letter-spacing-minus-1px line-height-50 sm-line-height-45 xs-line-height-30 no-margin-bottom">¿Quiénes somos?</h2>
                    </div>
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-12 col-lg-5 offset-lg-1 wow animate__fadeIn" data-wow-delay="0.2s">
                        <h5 class="alt-font text-green2 font-weight-500">FISPER</h5>
                        <p>FISPER surge en el año 2018 en Mérida Yucatán México. Es una firma que surge a raíz que se detectan las necesidades de llevar una correcta orientación en empresas y empresarios, a raíz de las reformas que han surgido en el país en las diferentes áreas.
                            <br><br>
                            Los emprendedores, empresarios, los grandes negocios, así como los medianos y pequeños negocios, estos, quedaron a la deriva por la falta de información clara y concisa, al detectar esa necesidad FISPER surge para poder aclarar toda esa información que surge hoy en día y así poder hacer que llegue la información completa para la toma de correctas decisiones con respecto al rumbo que lleva su empresa y negocio.</p>
